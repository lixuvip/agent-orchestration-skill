# Agy / Gemini Research Quality Template

Use this template after an external research pass returns. The coordinator may run it through `agy` or use it manually to score the research before accepting points.
